...
class Anuncio {
     ...
     * Add mensajes
     *
     * @param \Petlost\UsuarioBundle\Entity\Mensaje $mensajes
     * @return Anuncio
     */
    public function addMensaje(\Petlost\UsuarioBundle\Entity\Mensaje $mensajes)
    {
     ...
     * @param \Petlost\UsuarioBundle\Entity\Mensaje $mensajes
     */
    public function removeMensaje(\Petlost\UsuarioBundle\Entity\Mensaje $mensajes)
    {
